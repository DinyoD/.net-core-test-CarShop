namespace CarShop.Web.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [Display(Name = "Are you a mechanic or a client?")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                bool isMechanic = this.Input.IsMechanic == "Mechanic";
                ...
                if (result.Succeeded)
                {
                    ...
                    else
                    {
                        ...
                        var role = isMechanic ? GlobalConstants.MechanicRoleName : GlobalConstants.ClientRoleName;
